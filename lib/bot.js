...
Join Telegram Channel For Updates: @Discovery_Updates
...
function bot(torrent, bot) {
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const onDriveUpload = (torr, url) => bot.sendMessage(from, `${torr.name} uploaded to drive:\n${url} \nJoin Google Group to access GDrive Files: [Join Here](https://groups.google.com/d/forum/discovery-mirror-cloud) `);
